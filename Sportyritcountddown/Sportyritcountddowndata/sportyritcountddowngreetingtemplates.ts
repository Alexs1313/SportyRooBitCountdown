import type {SportyritcountddownGreetingStyle} from './sportyritcountddowngreetingtypes';

export const sportyritcountddownGreetingTemplates: Record<
...
export function sportyritcountddownFillGreetingTemplate(
  template: string,
  recipient: string,
  event: string,
): string {
...
export function sportyritcountddownPickRandomGreeting(
  style: SportyritcountddownGreetingStyle,
  recipient: string,
  event: string,
): string {
  const list = sportyritcountddownGreetingTemplates[style];
  const template = list[Math.floor(Math.random() * list.length)]!;
  return sportyritcountddownFillGreetingTemplate(template, recipient, event);
}
