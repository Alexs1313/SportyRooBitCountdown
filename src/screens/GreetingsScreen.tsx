...
function savedDateLabel(ms: number) {
  const d = new Date(ms);
...
const GreetingsScreen = () => {
  ...
  const [tab, setTab] =
    useState<greetTab>('generate');
  const [recipient, setRecipient] =
    useState('');
  const [event, setEvent] = useState('');
  const [style, setStyle] =
    useState<GreetingStyle>('Motivational');
        ...
        <View style={styles.resultCard}>
          <View style={styles.resultHead}>
            ...
            <View style={styles.resultBadge}>
              <Text style={styles.resultBadgeTxt}>
                {style}
              </Text>
            </View>
          </View>
          <View style={styles.resultBody}>
            <Text style={styles.resultBodyTxt}>
              {generated}
            </Text>
          </View>
        ...
        {saved.map(item => (
          <View
            ...
            <View style={styles.savedBody}>
              <Text style={styles.savedBodyTxt}>
                {item.body}
              </Text>
            </View>
