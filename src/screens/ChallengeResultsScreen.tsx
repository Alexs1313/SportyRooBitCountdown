...
type challngResultsNav = NativeStackNavigationProp<
  RootParamList,
  'ChallengeResults'
>;

type challngResultsRoute = RouteProp<
  RootParamList,
  'ChallengeResults'
>;
...
const ChallengeResultsScreen = () => {
  const navigation =
    useNavigation<challngResultsNav>();
  const route =
    useRoute<challngResultsRoute>();
      ...
      <View
        ...
        <View style={styles.headerTop}>
          <View style={styles.titleWrap}>
            <Text style={styles.eyebrow}>QUIZ RESULTS</Text>
